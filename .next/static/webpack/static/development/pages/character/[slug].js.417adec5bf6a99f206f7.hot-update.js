...
var CharacterPage = function CharacterPage(_ref) {
  var id = _ref.id,
      ...
      birth = _ref.birth;
  var subject = gender == "male" ? "he" : "she";
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_Layout_Layout__WEBPACK_IMPORTED_MODULE_4__["Layout"], {
    ...
    __self: this
  }, titles[0], " ", name, " Of ", house), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("img", {
    src: image,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 28
    ...
    __self: this
  }, subject, " was born in ", Math.abs(birth), " ", birth > 0 ? "A.C" : "B.C"), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("p", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 35
    },
    ...
    __self: this
  }, alive ? "".concat(subject, " still alive") : "".concat(subject, " passed away"), " "), spouse.length > 0 && react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("p", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 40
    },
...
//# sourceMappingURL=[slug].js.417adec5bf6a99f206f7.hot-update.js.map